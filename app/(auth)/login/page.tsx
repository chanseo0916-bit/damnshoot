...
function LoginForm() {
    ...
    return (
        <div className="amu-auth-shell font-display">
            {/* Header Section */}
            <div className="amu-auth-header">
                <div className="amu-auth-logo-wrap group">
                    <div className="amu-auth-logo-glow" />
                    <div className="amu-auth-logo-icon">
                        <span className="material-symbols-outlined">restaurant_menu</span>
                    </div>
                </div>
                <h1 className="amu-auth-title">AMU</h1>
                <p className="amu-auth-subtitle">
                    AMU 거나 좀 먹어라 제발
                </p>
            </div>
            ...
            <div className="amu-auth-form-wrap">
                ...
                {/* Email Form */}
                <form className="amu-auth-form" onSubmit={handleLogin}>
                ...
                {/* Footer Links */}
                <div className="amu-auth-footer">
                    <a href="#" className="amu-auth-link" onClick={(e) => e.preventDefault()}>
                        Forgot Password?
                    </a>
                    <Link href="/register" className="amu-auth-link-highlight">
                        Sign Up
                    </Link>
                </div>
            </div>
